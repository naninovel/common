...
public class MultilineManagedTextSerializerTest
{
    public static IEnumerable<object[]> Facts { get; } = new[] {
        ...
        Fact("# k1|k2\n; c1|c2\nv1|v2\n", "", 0, [new("k1", "v1", "c1"), new("k2", "v2", "c2")], [["k1", "k2"]]),
        Fact("# k1|k2\nv1|v2\n", "", 0, [new("k1", "v1"), new("k2", "v2")], [["k1", "k2"]]),
        Fact("# k1|k2\n|\n# k3\n; c3\n\n", "", 0, [new("k1"), new("k2"), new("k3", "", "c3")], [["k1", "k2"]]),
        Fact("# k1|k2\n; c1|c2\n|\n", "", 0, [new("k1", "", "c1"), new("k2", "", "c2")], [["k1", "k2"]]),
        Fact("# k1|k2\n; c1|c2\nv1|v2\n# k3|k4\nv3|v4\n", "", 0, [new("k1", "v1", "c1"), new("k2", "v2", "c2"), new("k3", "v3"), new("k4", "v4")], [["k1", "k2"], ["k3", "k4"]]),
        Fact("# k1|k2\n; c1|c2\nv1|v2\n# k3|k4\nv3|v4\n", "", 0, [new("k1", "v1", "c1"), new("k2", "v2", "c2"), new("k3", "v3"), new("k4", "v4")], [["k3", "k4"], ["k1", "k2"]]),
        Fact("# k1\nv1\n# k2|k3\nv2|v3\n# k4\nv4\n", "", 0, [new("k1", "v1"), new("k2", "v2"), new("k3", "v3"), new("k4", "v4")], [["k2", "k3"]]),
        Fact("# k1|k2|k3\n; c1||\n||v3\n", "", 0, [new("k1", "", "c1"), new("k2"), new("k3", "v3")], [["k1", "k2", "k3"]]),
        Fact("# k1|k2\n; c\\|1|c2\nv\\|1|v2\n", "", 0, [new("k1", "v|1", "c|1"), new("k2", "v2", "c2")], [["k1", "k2"]]),
        Fact("# 1\n\n# 2|3\n|\n# 4\n\n# 5|6|7\n||\n# 8\n\n", "", 0, [new("1"), new("2"), new("3"), new("4"), new("5"), new("6"), new("7"), new("8")], [["7", "5", "6"], ["3", "2"]])
    };
    ...
    private static object[] Fact (string expected, string header, int indent,
        ManagedTextRecord[] records, string[][] join = null)
    {
